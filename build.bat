...
vpk pack --packTitle "OSFR Launcher" --packAuthors "OSFR Team" -u OSFRLauncher -e OSFR Launcher.exe -o "%~dp0releases" -p "%~dp0publish" -i "%~dp0publish/App.ico" -f net9-x64-desktop -v %*